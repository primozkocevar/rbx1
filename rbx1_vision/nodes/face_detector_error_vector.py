...
############################################################################
        ...
        if len(faces) > 0:
            face_box = faces[0]
            current_face_position = face_box
        else:
        ...
        x_center = current_face_position[0]+current_face_position[2]/2
        y_center = current_face_position[1]+current_face_position[3]/2
        error_vector = [x_center-320/2 , y_center-240/2]
        print error_vector
