...
class cvBridgeDemo():
	...
	cameraTopic ="/camera/rgb/image_raw" 
	rospy.loginfo(cameraTopic)
        self.image_sub = rospy.Subscriber(cameraTopic, Image, self.image_callback, queue_size=1)
        self.depth_sub = rospy.Subscriber("input_depth_image", Image, self.depth_callback, queue_size=1)
        
        rospy.loginfo("Waiting for image topics...")
        rospy.wait_for_message(cameraTopic, Image)
        rospy.loginfo("Ready.")
